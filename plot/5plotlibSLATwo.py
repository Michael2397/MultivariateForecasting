...
for num in(range(288)):
    ...
    xLinear.append(num)
#从文件读取虚拟机个数
yTxt = open('5plotlibSLA.txt')  #worst
yRead=yTxt.read()
yList = yRead.split(' ')

yTxt4 = open('5plotlibSLALinear.txt')  #线性
yRead4=yTxt4.read()
yList4 = yRead4.split(' ')

yTxt2 = open('5plotlibSLALSTM.txt')  #lstm
yRead2=yTxt2.read()
yList2 = yRead2.split(' ')

yTxt3 = open('5plotlibSLALSTMQL.txt')  #lstmQl
yRead3=yTxt3.read()
yList3 = yRead3.split(' ')
...
for num in(range(288)):
    ...
    xCLinear.append(num)
#从文件读取虚拟机个数
yCTxt = open('5plotlibSLATwo.txt')  #worst
yCRead=yCTxt.read()
yCList = yCRead.split(' ')

yCTxt4 = open('5plotlibSLATwo.txt')  #线性
yCRead4=yCTxt4.read()
yCList4 = yCRead4.split(' ')

yCTxt2 = open('5plotlibSLALSTMTwo.txt')  #lstm
yCRead2=yCTxt2.read()
yCList2 = yCRead2.split(' ')

yCTxt3 = open('5plotlibSLALSTMQLTwo.txt')  #lstmQl
yCRead3=yCTxt3.read()
...
plt.ylabel('Total delay time interval of NASA(sec) ', fontsize=15)
...
plt.legend() # 显示图例
plt.xlabel('Time interval(5min)', fontsize=15)
plt.ylabel('Total delay time of ClarkNet(sec) ', fontsize=15)
plt.show()
